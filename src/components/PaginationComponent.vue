    ...
    <div class="py-4 d-flex align-items-center justify-content-center">
        <nav aria-label="pagination">
            <ul class="pagination">
                ...
                <li class="page-item" v-for="page in store.api_data.AllProjects.infoPagination.last_page" :key="page">
                ...
                <li class="page-item"
                    :class="{ 'disabled': store.paramsObject.page >= store.api_data.AllProjects.infoPagination.last_page }">
